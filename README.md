...
> *"Конспекты больше не должны быть скучными."*

## 📸 Демо

<div align="center">
  <img src=".github/assets/demo.png" alt="Screenshot" width="100%" style="border-radius: 20px; box-shadow: 0 0 20px rgba(0,0,0,0.5);">
</div>
